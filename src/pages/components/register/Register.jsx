	...
	return (
		<div>
			<div className="login-form col-11 col-sm-10 col-md-8 mx-auto py-5 px-4">
				<div className="display-6 fw-bold text-center pb-5">
					Register your account
				</div>
				<hr />
				<form className="mt-5">
					<div>
						<div className="fs-5 fw-bold mb-3">Your Name</div>
						<div>
							<input
					...
					<div>
						<div className="fs-5 fw-bold mb-3">Photo URL</div>
						<div>
							<input
								className="input-field"
					...
					<div>
						<div className="fs-5 fw-bold mb-3">Email address</div>
						<div>
							<input
								className="input-field"
					...
					<div>
						<div className="fs-5 fw-bold mb-3">Password</div>
						<div>
							<input
								className="input-field"
